...
const ReviewedProposalsPage = () => {
    ...
    const fetchAssignments = async () => {
        setLoading(true);
        try {
            const response = await reviewAssignmentApi.getAssignedProposals(page + 1, rowsPerPage, 'COMPLETED');
            if (response.status) {
            ...
            <Box mb={4} display="flex" justifyContent="space-between" alignItems="center">
                <Box>
                    ...
                    <Typography variant="body2" color="textSecondary" sx={{ mt: 0.5 }}>
                        View the proposals you have already reviewed.
                    </Typography>
                </Box>
            </Box>
                                    ...
                                    <TableCell colSpan={5} align="center" sx={{ py: 6 }}>
                                        <Box display="flex" flexDirection="column" alignItems="center" gap={2}>
                                            ...
                                            <Typography variant="body1" color="textSecondary">
                                                You have not reviewed any proposals yet.
                                            </Typography>
                                        </Box>
                                    </TableCell>
                                </TableRow>
                                    ...
                                    <TableRow key={assignment._id} hover>
                                        <TableCell>
                                            ...
                                            <Typography variant="caption" color="textSecondary">
                                                {assignment.proposalDetails?.title || 'Unknown Title'}
                                            </Typography>
                                        </TableCell>
                                        <TableCell>
                                            <Chip 
...
export default ReviewedProposalsPage;
